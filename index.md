...
1. **[README_SIMPLE.md](./doc/README_SIMPLE.md)** ⭐ START HERE - Simple explanation of what this is
2. **[PROJECT_FINAL_SUMMARY.md](./doc/PROJECT_FINAL_SUMMARY.md)** - Complete project overview
3. **[TROJAN_PROTOCOL_ARCHITECTURE.md](./doc/TROJAN_PROTOCOL_ARCHITECTURE.md)** - Understanding the protocol
4. **[LETSENCRYPT_QUICKSTART.md](./doc/LETSENCRYPT_QUICKSTART.md)** - Getting Let's Encrypt running
